...
The data preparation required an extensive effort in building complex ETL pipelines.
...
We evaluated the accuracy and diversity of the matchmakers on the task of predicting the winning bidders of contracts by using retrospective data on contract awards spanning ten years
