...
Příprava dat si vyžádala rozsáhlé úsilí při tvorbě komplexních ETL procesů.
Jako rámec datové integrace jsme využili propojená otevřená data.
...
Evaluaci přesnosti a diverzity metod párování jsme provedli na úloze predikce vítězných uchazečů o zakázky v retrospektivních datech o zakázkách udělených během doby 10 let.
